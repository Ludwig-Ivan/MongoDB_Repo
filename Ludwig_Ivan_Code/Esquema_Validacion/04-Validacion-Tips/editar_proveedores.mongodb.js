...
//? Ejecuta un comando en este caso una modificacion a la collecion proveedores
db.runCommand({
    collMod: 'Proveedores',
    validator: {
        $jsonSchema: {
            ...
            //? nomas se agrego a los atributos requeridps la direccion y telefono
            required: ['nombre', 'contacto_nombre', 'email', 'contrasena', 'tipo', 'direccion', 'telefono'],
            properties: {
                _id: {
                    bsonType: 'objectId',
                },
